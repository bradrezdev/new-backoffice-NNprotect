...
Revision ID: cba6f5780671
Revises: 
Create Date: 2025-10-30 10:16:43.154422
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('unilevelreports', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_unilevelreports_id'), ['id'], unique=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('unilevelreports', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_unilevelreports_id'))
